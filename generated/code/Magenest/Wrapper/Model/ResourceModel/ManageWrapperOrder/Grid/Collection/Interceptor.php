<?php
namespace Magenest\Wrapper\Model\ResourceModel\ManageWrapperOrder\Grid\Collection;

/**
 * Interceptor class for @see \Magenest\Wrapper\Model\ResourceModel\ManageWrapperOrder\Grid\Collection
 */
class Interceptor extends \Magenest\Wrapper\Model\ResourceModel\ManageWrapperOrder\Grid\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Data\Collection\EntityFactoryInterface $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, $mainTable = 'magenest_manage_wrapper_order', $resourceModel = null, $identifierName = null, $connectionName = null)
    {
        $this->___init();
