<?php
namespace Magenest\Wrapper\Model\ResourceModel\Quote\Wrapper\Collection;

/**
 * Interceptor class for @see \Magenest\Wrapper\Model\ResourceModel\Quote\Wrapper\Collection
 */
class Interceptor extends \Magenest\Wrapper\Model\ResourceModel\Quote\Wrapper\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function getAllWrapperIds()
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllWrapperIds');
        return $pluginInfo ? $this->___callPlugins('getAllWrapperIds', func_get_args(), $pluginInfo) : parent::getAllWrapperIds();
    }
