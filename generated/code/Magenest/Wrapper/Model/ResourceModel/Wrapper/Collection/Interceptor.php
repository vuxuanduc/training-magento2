<?php
namespace Magenest\Wrapper\Model\ResourceModel\Wrapper\Collection;

/**
 * Interceptor class for @see \Magenest\Wrapper\Model\ResourceModel\Wrapper\Collection
 */
class Interceptor extends \Magenest\Wrapper\Model\ResourceModel\Wrapper\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Data\Collection\EntityFactoryInterface $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, \Magento\Framework\Model\ResourceModel\Iterator $iterator, \Magenest\Wrapper\Helper\Data $helperData, ?\Magento\Framework\DB\Adapter\AdapterInterface $connection = null, ?\Magento\Framework\Model\ResourceModel\Db\AbstractDb $resource = null)
    {
        $this->___init();
        parent::__construct($entityFactory, $logger, $fetchStrategy, $eventManager, $iterator, $helperData, $connection, $resource);
    }

    /**
     * {@inheritdoc}
     */
    public function isCustomerAllowedToViewWrapper($customerGroupId)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isCustomerAllowedToViewWrapper');
        return $pluginInfo ? $this->___callPlugins('isCustomerAllowedToViewWrapper', func_get_args(), $pluginInfo) : parent::isCustomerAllowedToViewWrapper($customerGroupId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'callBack');
        return $pluginInfo ? $this->___callPlugins('callBack', func_get_args(), $pluginInfo) : parent::callBack($arg);
    }

    /**
     * {@inheritdoc}
     */
    public function addCategoryIdToFilter($categoryId)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addCategoryIdToFilter');
        return $pluginInfo ? $this->___callPlugins('addCategoryIdToFilter', func_get_args(), $pluginInfo) : parent::addCategoryIdToFilter($categoryId);
    }
