...
class Interceptor extends \Magento\Quote\Model\ResourceModel\Quote\Address\Rate\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\Data\Collection\EntityFactory $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, \Magento\Framework\Model\ResourceModel\Db\VersionControl\Snapshot $entitySnapshot, \Magento\Shipping\Model\CarrierFactoryInterface $carrierFactory, \Magento\Quote\Model\ResourceModel\Quote\Address\Rate\Delete $deleteRates, ?\Magento\Framework\DB\Adapter\AdapterInterface $connection = null, ?\Magento\Framework\Model\ResourceModel\Db\AbstractDb $resource = null)
    {
        $this->___init();
        parent::__construct($entityFactory, $logger, $fetchStrategy, $eventManager, $entitySnapshot, $carrierFactory, $deleteRates, $connection, $resource);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setAddressFilter');
        return $pluginInfo ? $this->___callPlugins('setAddressFilter', func_get_args(), $pluginInfo) : parent::setAddressFilter($addressId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setFixedOnlyFilter');
        return $pluginInfo ? $this->___callPlugins('setFixedOnlyFilter', func_get_args(), $pluginInfo) : parent::setFixedOnlyFilter($value);
    }
    ...
    public function addItem(\Magento\Framework\DataObject $rate)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addItem', func_get_args(), $pluginInfo) : parent::addItem($rate);
    }
