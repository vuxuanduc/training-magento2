...
class Interceptor extends \Magento\Sales\Model\ResourceModel\Order\Tax\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'loadByOrder');
        return $pluginInfo ? $this->___callPlugins('loadByOrder', func_get_args(), $pluginInfo) : parent::loadByOrder($order);
    }
