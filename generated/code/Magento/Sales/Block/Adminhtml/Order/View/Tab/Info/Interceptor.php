...
class Interceptor extends \Magento\Sales\Block\Adminhtml\Order\View\Tab\Info implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTrackingHtml');
        return $pluginInfo ? $this->___callPlugins('getTrackingHtml', func_get_args(), $pluginInfo) : parent::getTrackingHtml();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemsHtml');
        return $pluginInfo ? $this->___callPlugins('getItemsHtml', func_get_args(), $pluginInfo) : parent::getItemsHtml();
    }
