...
class Interceptor extends \Magento\ProductVideo\Block\Adminhtml\Product\Edit\NewVideo implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getWidgetOptions');
        return $pluginInfo ? $this->___callPlugins('getWidgetOptions', func_get_args(), $pluginInfo) : parent::getWidgetOptions();
    }
