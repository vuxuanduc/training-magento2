...
class Interceptor extends \Magento\CatalogWidget\Block\Product\ProductsList implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function getBaseCollection() : \Magento\Catalog\Model\ResourceModel\Product\Collection
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBaseCollection');
        return $pluginInfo ? $this->___callPlugins('getBaseCollection', func_get_args(), $pluginInfo) : parent::getBaseCollection();
    }
