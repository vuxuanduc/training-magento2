...
class Interceptor extends \Magento\ConfigurableProduct\Block\Adminhtml\Product\Edit\Tab\Variations\Config\Matrix implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getVariations');
        return $pluginInfo ? $this->___callPlugins('getVariations', func_get_args(), $pluginInfo) : parent::getVariations();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProvider');
        return $pluginInfo ? $this->___callPlugins('getProvider', func_get_args(), $pluginInfo) : parent::getProvider();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getModal');
        return $pluginInfo ? $this->___callPlugins('getModal', func_get_args(), $pluginInfo) : parent::getModal();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getConfigurableModal');
        return $pluginInfo ? $this->___callPlugins('getConfigurableModal', func_get_args(), $pluginInfo) : parent::getConfigurableModal();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getEditProductUrl');
        return $pluginInfo ? $this->___callPlugins('getEditProductUrl', func_get_args(), $pluginInfo) : parent::getEditProductUrl($id);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getImageUploadUrl');
        return $pluginInfo ? $this->___callPlugins('getImageUploadUrl', func_get_args(), $pluginInfo) : parent::getImageUploadUrl();
    }

    /**
     * {@inheritdoc}
     */
    public function getProductStockQty(\Magento\Catalog\Model\Product $product)
    {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getVariationWizard');
        return $pluginInfo ? $this->___callPlugins('getVariationWizard', func_get_args(), $pluginInfo) : parent::getVariationWizard($initData);
    }
