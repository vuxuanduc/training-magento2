...
class Interceptor extends \Magento\Vault\Model\Method\Vault implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProviderCode');
        return $pluginInfo ? $this->___callPlugins('getProviderCode', func_get_args(), $pluginInfo) : parent::getProviderCode();
    }
}
